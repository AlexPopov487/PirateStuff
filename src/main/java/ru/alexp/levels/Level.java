...
import ru.alexp.entities.Crabby;
import ru.alexp.entities.PinkStar;
import ru.alexp.levelObjects.Container;
...
public class Level {
    ...
    private final List<ru.alexp.levelObjects.Container> containers = new ArrayList<>();
    ...
    private void loadObjects(int blueValue, int x, int y) {
        if (blueValue == LevelObjectType.BARREL.getBluePixelValue()) {
            containers.add(new ru.alexp.levelObjects.Container(x * GamePanel.getCurrentTileSize(), y * GamePanel.getCurrentTileSize(), LevelObjectType.BARREL));
        } else if (blueValue == LevelObjectType.BOX.getBluePixelValue()) {
            containers.add(new ru.alexp.levelObjects.Container(x * GamePanel.getCurrentTileSize(), y * GamePanel.getCurrentTileSize(), LevelObjectType.BOX));
