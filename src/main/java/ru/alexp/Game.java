...
import ru.alexp.audio.AudioPlayer;
import ru.alexp.gameState.GameOverOverlay;
import ru.alexp.gameState.Menu;
import ru.alexp.gameState.Playing;
import ru.alexp.gameState.Settings;
...
public class Game implements Runnable {
    ...
    private final ru.alexp.gameState.Menu menu;
    ...
    public Game() {
        ...
        menu = new ru.alexp.gameState.Menu(this);
